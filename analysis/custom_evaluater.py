...
class Evaluater(BaseEvaluater):
    ...
    def evaluate_batchwise(self):
        ...
        with torch.no_grad():
            ...
            losses_array = np.concatenate(loss2save)
            np.save('./test_losses.npy', losses_array)
            print('save losses')
    ...
    def analyze(self, challenge_metrics):
        ...
        macro_f_beta_measure, macro_g_beta_measure, f_beta_measure, g_beta_measure = challenge_metrics.beta_measures(self._to_np(outputs_logit), self._to_np(targets))
