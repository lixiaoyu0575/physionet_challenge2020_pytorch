        ...
        hp.choice('arch', [
            {
                ...
                'args':
                    {
                        "layers": hp.choice('layers', [[2, 2, 1, 3], [3,2,1,3], [3,2,1,2]]),
                        "bottleneck_width": hp.choice('bottleneck_width', [64, 32]),
                        "stem_width": hp.choice('stem_width', [16]),
                        "num_classes": 108,
                        "kernel_size": hp.choice('kernel_size', [7, 11, 15])
                    }
            }
        ]),
        ...
        hp.choice('optimizer', [
            {
                ...
                'args':
                    {
                        'lr': hp.choice('lr', [0.008, 0.001, 0.0005]),
    ...
    'lr_scheduler':
        hp.choice('lr_scheduler', [

            {
                 "type": "MultiStepLR",
                    "args": {
                        "milestones": hp.choice('milestones', [[15,25,40],[15,25,40]]),
                        "gamma": 0.1
                    }
            },
        ...
        hp.choice('trainer', [
            {
                ...
                'early_stop': hp.choice('early_stop', [15])
            },
        ])
}
...
space = {
    ...
    'trainer':
        hp.choice('trainer', [
            {
                "epochs": hp.choice('epochs', [100]),
                "batch_size": hp.choice('batch_size', [64, 32]),
                "monitor": hp.choice('monitor', ['min val_loss', 'max val_challenge_metric']),
                'early_stop': hp.choice('early_stop', [15])
            },
        ])
