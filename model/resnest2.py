...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, radix=1, groups=1, bottleneck_width=64,
        ...
        if deep_stem:
            ...
            self.conv1 = conv_layer(12, 32, kernel_size=(kernel_size * 2 + 1), stride=2, padding=kernel_size,
...
def resnest2(pretrained=False, layers=[3, 4, 6, 3], radix=2, groups=1, bottleneck_width=64,
