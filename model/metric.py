...
def compute_confusion_matrices(outputs, labels, normalize=False):
...
def compute_f_measure(outputs, labels):
    num_recordings, num_classes = np.shape(labels)
...
def compute_beta_measures(outputs, labels, beta):
    num_recordings, num_classes = np.shape(labels)
...
def compute_auc(outputs, labels):
    num_recordings, num_classes = np.shape(labels)
