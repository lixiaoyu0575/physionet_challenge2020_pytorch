...
def WTfilt_1d(sig):
    ...
    return rdata
def get_preprocessed_data(result):
    ...
    for i in range(len(result)):
        print('get preprocessed data '+result[i][0])
        ...
        ##patient
        patient_info_each = []
        patient_info_each.append(result[i][0])
